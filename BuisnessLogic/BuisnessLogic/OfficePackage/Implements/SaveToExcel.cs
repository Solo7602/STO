...
namespace BuisnessLogic.BusinessLogic.OfficePackage.Implements
{
    ...
    "http://schemas.microsoft.com/office/spreadsheetml/2010/11/main");
        ...
        protected override void CreateExcel(ExcelInfoRepairWork info)
        {
        ...
        protected override void CreateExcel(ExcelInfoServiceVisit info)
        {
            _spreadsheetDocument = SpreadsheetDocument.Create(info.FileName,
          SpreadsheetDocumentType.Workbook);
            // Создаем книгу (в ней хранятся листы)
        ...
        protected override void SaveExcel(ExcelInfoRepairWork info)
        {
            _spreadsheetDocument.WorkbookPart.Workbook.Save();
            _spreadsheetDocument.Close();
        }

        protected override void SaveExcel(ExcelInfoServiceVisit info)
        {
            _spreadsheetDocument.WorkbookPart.Workbook.Save();
            _spreadsheetDocument.Close();
        }
